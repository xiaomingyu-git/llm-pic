    ...
    <div class="diagram-code">
        ...
        <div class="code-editor-container" :class="{ fullscreen: isFullscreen }">
            <div class="sidebar">
                ...
                <div class="toolbar">
                    <el-tooltip content="格式化代码" placement="right">
                        <el-button @click="formatCode" size="small" circle :disabled="!code">
                            <el-icon>
                                <Magic />
                            </el-icon>
                        </el-button>
                    ...
                    <el-tooltip content="清空代码" placement="right">
                        <el-button @click="clearCode" size="small" circle type="danger" :disabled="!code">
                            <el-icon>
                                <Delete />
                            </el-icon>
                        </el-button>
                    ...
                    <div class="theme-selector">
                        <el-select v-model="selectedTheme" size="small" placeholder="主题" @change="handleThemeChange">
            ...
            <div class="editor-main">
                ...
                <textarea ref="codeEditor" v-model="editableCode" class="code-editor" :style="{
                    fontSize: fontSize + 'px',
                    fontFamily: selectedFont,
                    lineHeight: lineHeight + 'px',
                }" spellcheck="false" @scroll="syncLineNumbers" @keydown="handleKeyDown" @input="handleInput"
                    @click="updateCurrentLine" @keyup="updateCurrentLine" placeholder="图表代码将显示在这里..." />

                <!-- 语法高亮覆盖层 -->
                <div ref="syntaxHighlight" class="syntax-highlight" v-html="highlightedCode" :style="{
                    fontSize: fontSize + 'px',
                    fontFamily: selectedFont,
                    lineHeight: lineHeight + 'px',
                }" @click="focusEditor" />
        ...
        <div class="status-bar">
            ...
            <div class="status-right">
                <el-button @click="toggleWordWrap" size="small" type="text" :class="{ active: wordWrap }">
                    <el-icon>
                        <Sort />
                    </el-icon>
                    自动换行
