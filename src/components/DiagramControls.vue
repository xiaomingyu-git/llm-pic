<template>
  <div class="diagram-controls">
    ...
    <div class="format-controls">
      ...
      >
        <el-option
          v-for="format in diagramFormats"
          :key="format.value"
          :label="format.label"
          :value="format.value"
        >
...
// Emits
interface Emits {
  (e: 'generate-diagram', options: { format: string; options: GenerateOptions }): void
...
const showStatus = (type: StatusInfo['type'], title: string, description?: string) => {
