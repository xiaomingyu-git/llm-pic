        ...
        <el-card>
            ...
            <el-form :model="input" label-width="80px">
                <el-form-item label="描述">
                    <el-input v-model="input.description" type="textarea" :rows="4"
                        placeholder="描述您想要生成的系统架构，例如：创建一个包含前端、后端和数据库的Web应用程序" maxlength="500" show-word-limit />
                </el-form-item>
        ...
        <el-card v-if="diagramCode">
            <template #header>
                <div class="card-header">
                    ...
                    <div>
                        <el-button size="small" @click="toggleFullscreen" v-if="activeTab === 'diagram'">
                            <el-icon>
                                <FullScreen />
                            </el-icon>
                ...
                <el-tab-pane label="代码编辑" name="code">
                    <div class="code-editor-container">
                        <div class="editor-header">
                            ...
                            <el-button size="small" type="primary" @click="applyChanges" :disabled="codeLoading">
                                <el-icon>
                                    <Refresh />
                                </el-icon>
                        ...
                        <div class="code-editor-wrapper">
                            <el-input v-model="editableCode" type="textarea" :rows="20"
                                placeholder="在这里编辑 Mermaid 代码..." class="code-editor" @input="onCodeChange" />
                        </div>
                        <div class="editor-footer">
                            <el-button size="small" @click="resetCode" :disabled="originalCode === editableCode">
                                重置为原始代码
                            </el-button>
...
// 延迟初始化（在用户实际需要时才加载）
onMounted(() => {
    // 不立即加载，等到用户首次生成图表时再加载
    console.log('Mermaid将在首次使用时动态加载');
});
